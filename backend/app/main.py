...
from app.services.reference_comparator import reference_comparator
from app.services.image_extractor import image_extractor
from app.services.image_text_comparator import image_text_comparator
...
async def compare_with_reference(
    ...
    Args:
        ...
        similarity_threshold: 相似度阈值（0-1），默认0.3（30%）
