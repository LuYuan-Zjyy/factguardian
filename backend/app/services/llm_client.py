...
请以 JSON 数组格式返回提取的事实，每个事实包含以下字段：
- type: 事实类型，可选值：["数据", "日期", "人名", "机构", "结论", "事件"]
- content: 事实的简洁描述
- original_text: 原文中的相关片段（直接引用）
...
[
  {{
    "type": "数据",
    "content": "销售额达到100万",
    "original_text": "本季度销售额突破100万元大关",
    "confidence": 0.95
  }},
  {{
    "type": "日期",
    "content": "2024年第一季度",
    "original_text": "在2024年第一季度",
    "confidence": 0.98
  }}
]
```
